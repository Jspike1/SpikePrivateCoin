...
private slots:
    ...
    void on_BuySPC_clicked();
    void on_SellSPCBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputSPC_textChanged(const QString &arg1);
    ...
    QString BuySPC(QString OrderType, double Quantity, double Rate);
    QString SellSPC(QString OrderType, double Quantity, double Rate);
