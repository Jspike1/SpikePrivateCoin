...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SpikesPrivateCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SpikesPrivateCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("SpikesPrivateCoin-start");
